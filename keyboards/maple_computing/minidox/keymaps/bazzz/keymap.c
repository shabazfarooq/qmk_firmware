...
[_QWERTY] = LAYOUT( \
  ...
  SYS_Z,   KC_X,    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SCLN, \
                    SYM_OS,  NAV_BK,  SFT_OS,       KC_ENT,  NUMN_SPC, SFT_OS                     \
),
 ...
 *                                `------'    `------'
     ...
     this is the space layer

 */
[_NUM_N] = LAYOUT( \
  KC_ESC, _______, KC_WH_U, KC_WH_D, _______,       KC_BSPC, KC_PGUP, KC_UP,   KC_PGDN, KC_END,  \
  KC_GRV, KC_TAB, KC_LALT, KC_LGUI, NAV_LK,        KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_HOME, \
 ...
 *                                |      |    |      |
 *                                `------'    `------'
   this is the backspace layer

 */
[_NAV] = LAYOUT( \
  KC_GRV,   KC_F2,   KC_F3,   KC_F4,   KC_F5,         KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  \
